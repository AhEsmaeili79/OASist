...
def print_help():
    ...
    content.add_row("python oasist_client.py <command> [options]")
    content.add_row("")
    ...
    content.add_row("python oasist_client.py --help")
    content.add_row("python oasist_client.py help generate")
    content.add_row("python oasist_client.py generate --help")
    content.add_row("python oasist_client.py list")
    content.add_row("python oasist_client.py generate user")
    content.add_row("python oasist_client.py generate user --force")
    content.add_row("python oasist_client.py generate-all")
    content.add_row("python oasist_client.py info user")
...
def print_command_help(command: str) -> None:
    ...
    if command == 'list':
        ...
        body.add_row("python oasist_client.py list [--help|-h]")
    ...
    if command == 'generate':
        ...
        body.add_row("")
        body.add_row("[bold]USAGE[/bold]")
        body.add_row("python oasist_client.py generate <service> [--force] [--help|-h]")
        body.add_row("")
    ...
    if command == 'generate-all':
        ...
        body.add_row("")
        body.add_row("[bold]USAGE[/bold]")
        body.add_row("python oasist_client.py generate-all [--force] [--help|-h]")
        body.add_row("")
        body.add_row("[bold]OPTIONS[/bold]")
    ...
    if command == 'info':
        ...
        body.add_row("")
        body.add_row("[bold]USAGE[/bold]")
        body.add_row("python oasist_client.py info <service> [--help|-h]")
        console.print(Panel(body, title="Command Help", box=box.ROUNDED))
        return
